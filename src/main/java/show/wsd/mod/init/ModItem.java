...
public class ModItem {
    ...
    private static final int SUPER_LONG_DURATION = 24000;    // 20 minutes

    // Feast Portions
    private static final FoodProperties FOOD_STUFFED_TAINTED_PUMPKIN = new FoodProperties.Builder()
            .nutrition(16).saturationMod(1.4f)
            .effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), LONG_DURATION, 0), 1.0F)
            .build();

    private static final FoodProperties FOOD_STUFFED_COMMAND_BLOCK = new FoodProperties.Builder()
            .nutrition(22).saturationMod(1.4f)
            .effect(() -> new MobEffectInstance(MobEffects.REGENERATION, BRIEF_DURATION, 0), 1.0F)
            .effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), LONG_DURATION, 0), 1.0F)
            .build();

    private static final FoodProperties FOOD_STORM_DINNER = new FoodProperties.Builder()
            .nutrition(24).saturationMod(1.2f)
            .effect(() -> new MobEffectInstance(MobEffects.REGENERATION, BRIEF_DURATION, 0), 1.0F)
            .effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), LONG_DURATION, 0), 1.0F)
            .build();

    private static final FoodProperties FOOD_COOKED_ZOMBIE = new FoodProperties.Builder()
            .nutrition(13).saturationMod(0.7f)
            .effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), MEDIUM_DURATION, 0), 1.0F)
            .build();

    private static final FoodProperties FOOD_WITHER_BARBECUE = new FoodProperties.Builder()
            .nutrition(9).saturationMod(1.1f)
            .build();

    private static final FoodProperties FOOD_STORM_POPSICLE = new FoodProperties.Builder()
            .nutrition(4).saturationMod(0.2f)
            .build();

    private static final FoodProperties FOOD_STORM_SANDWICH = new FoodProperties.Builder()
            .nutrition(12).saturationMod(1f)
            .build();

    private static final FoodProperties FOOD_EYES_PORRIDGE = new FoodProperties.Builder()
            .nutrition(10).saturationMod(0.7f)
            .effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), MEDIUM_DURATION, 1), 1.0F)
            .build();

    private static final FoodProperties FOOD_FRIED_RICE = new FoodProperties.Builder()
            .nutrition(16).saturationMod(1f)
            .effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), LONG_DURATION, 0), 2.0F)
            .build();

    private static final FoodProperties FOOD_COOKED_RICE = new FoodProperties.Builder()
            .nutrition(7).saturationMod(1f)
            .effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), BRIEF_DURATION, 0), 2.0F)
            .build();

    private static final FoodProperties FOOD_SALAD = new FoodProperties.Builder()
            .nutrition(6).saturationMod(1.2f)
            .effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), BRIEF_DURATION, 0), 2.0F)
            .effect(() -> new MobEffectInstance(MobEffects.ABSORPTION, MEDIUM_DURATION, 1), 1.0F)
            .build();

    private static final FoodProperties FOOD_PIE_SLICE = new FoodProperties.Builder()
            .nutrition(2).saturationMod(0.5f)
            .build();

    private static final FoodProperties FOOD_BIG_MAC_BURGER = new FoodProperties.Builder()
            .nutrition(10).saturationMod(1.2f)
            .build();
    private static final FoodProperties FOOD_WITHERED_CABBAGE = new FoodProperties.Builder()
            .nutrition(3).saturationMod(0.5f)
            .build();

    private static final FoodProperties FOOD_WITHERED_TOMATO = new FoodProperties.Builder()
            .nutrition(2).saturationMod(0.4f)
            .build();

    private static final FoodProperties FOOD_WITHERED_ONION = new FoodProperties.Builder()
            .nutrition(4).saturationMod(0.6f)
            .build();

    private static final FoodProperties FOOD_WITHERED_BONE_BROTH = new FoodProperties.Builder()
            .nutrition(9).saturationMod(1f).effect(() -> new MobEffectInstance(ModEffects.NOURISHMENT.get(), SHORT_DURATION, 0), 1.0F)
            .meat()
            .build();

    private static final FoodProperties FOOD_WITHERED_TOMATO_SAUCE = new FoodProperties.Builder()
            .nutrition(3).saturationMod(0.7f)
            .meat()
            .build();

    private static final FoodProperties FOOD_GOLDEN_APPLE_STEW_LARGE_BOWL = new FoodProperties.Builder()
    ...
    private static final FoodProperties FOOD_WITHER_ROSE_PETAL_TEA = new FoodProperties.Builder()
    ...
    public static final RegistryObject<Item> WITHER_ROSE_PETAL_TEA = ITEMS.register("wither_rose_petal_tea",
            () -> new DrinkableItem(drinkItem(FOOD_WITHER_ROSE_PETAL_TEA).rarity(Rarity.UNCOMMON),
                    true, false));
    private static Item.Properties bowlFoodItem(FoodProperties food) {
        return new Item.Properties()
                .food(food)
                .craftRemainder(Items.BOWL)
                .stacksTo(16);
    }
    private static Item.Properties drinkItem(FoodProperties food) {
        return new Item.Properties()
                .food(food)
                .craftRemainder(Items.GLASS_BOTTLE)
                .stacksTo(16);
    }
    private static Item.Properties stickFoodItem(FoodProperties food) {
        return new Item.Properties()
                .food(food)
